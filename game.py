...
questions_answers = {
    ...
    "Quem foi Leonardo da Vinci?": "um pintor e inventor",
    ...
    "Quem foi Albert Einstein?": "um físico teórico",
    ...
    "Quem foi Galileu Galilei?": "um astrônomo e físico",
    ...
    "Quem foi Martin Luther King Jr.?": "um líder dos direitos civis",
    "Qual é o maior estado do Brasil em área?": "amazonas",
    "Quem escreveu 'A Divina Comédia'?": "dante alighieri",
    "Quem foi Isaac Newton?": "um físico e matemático",
    "Qual é a capital da Argentina?": "buenos aires",
    "Quem inventou o avião?": "irmãos wright",
