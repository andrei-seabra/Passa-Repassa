...
questions_answers = {
    ...
    'Quem foi o autor de "Dom Casmurro"?': "machado de assis",
    "Qual é a fórmula do gás carbônico?": "co2",
    "Qual é a terceira lei de Newton?": "ação e reação",
    ...
    "Qual é a fórmula do cloreto de sódio?": "nacl",
    'Quem pintou "Guernica"?': "pablo picasso",
    "Qual é o símbolo químico do cálcio?": "ca",
    'Quem escreveu "1984"?': "george orwell",
    "Quem foi Sócrates?" : "filósofo",
    'Quem pintou "A Escola de Atenas"?': "rafael",
    'Quem pintou "A Última Ceia"?': "leonardo da vinci",
    "Qual é o símbolo químico do lítio?": "li",
    "Qual é o símbolo químico do cobre?": "cu",
    "Calcule a média dos números 4 e 8": "6",
    "Calcule a média dos números 3, 7 e 4": "7",
    ...
    "Qual é a unidade de medida de força?": "Newton",
    "Qual é a unidade de medida de energia?": "Joule",
    "Qual é a unidade de medida de potência?": "Watt",
